document.addEventListener('DOMContentLoaded', () => {
    ...
    //id="target-section"
    const rectangleTexts = ['A group of boers known as Jerusalemgangers believed they could trek to Jerusalem from Gauteng', 'Moses went South', 'Christianity is based on Ancient Egyptian beliefs', 'The Jews in Israel have no connection to the land of palestine or the Hebrews who followed Moses', 'The banks cause inflation because its profitable for them', "Israel's economy is dependenent on the exploitation of Africa", 'israel is a fake country', 'they were initially going to create israel in Uganda', 'his-story is whitewashed','The trans-atlantic slave trade began when the black jews of Spain and Portugal were persecuted','The Jewish identity has been whitewashed', "Africa has always been influencing the world", "Theres is no such thing as a 'red' sea, only a sea of reeds", "The bible is a story about africans in african land"]; // Corrected list of texts
    let currentIndex = 0;
